...
const ProPlanActivatedEmail = ({
  ...
  return (
    <Html>
      <Head />
      <Preview>
        Welcome to StripeSimplified Pro - Your premium learning journey begins!
      </Preview>
      <Body style={main}>
          ...
          <Section style={content}>
            ...
            <Section style={proSection}>
              <Text style={thankYouText}>
                Thank you for upgrading to StripeSimplified Pro! Your {planType}
                ly subscription is now active.
              </Text>
